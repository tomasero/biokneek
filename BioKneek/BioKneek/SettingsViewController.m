...
- (void)viewDidLoad {
    [super viewDidLoad];
    AppViewController *appVW = [AppViewController init];
    self.feedbackVC = appVW.feedbackVC;
...
- (void) setUI {
    ...
    [self.view  bringSubviewToFront:activeResponseCell];
    [activeResponseCell setUserInteractionEnabled:YES];
    [activeResponseCell.cellSwitch setUserInteractionEnabled:YES];
